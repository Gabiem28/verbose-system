...
public class RPSLSDF {
    ...
    System.out.print("Enter Player " + num + "'s name: ");
    name = input.nextLine();
    ...
    System.out.println("*********Current stats*********" +
                        player1 + ": " + player1Wins + " wins\n" +
                       player2 + ": " + player2Wins + " wins\n" +
                       player3 + ": " + player3Wins + " wins\n" +
                       "*******************************");
	}
	/**
	...
	public static void reportGame(int result,String player1,String player2) {
     ...
     if(result == 1)
      {
        System.out.println(player1 + " vs. " + player2 + " - Winner: " + player1);
      }
      else if(result == -1)
      {
        System.out.println(player1 + " vs. " + player2 + " - Winner: " + player2);
      }
      else if(result == 0)
      {
        System.out.println(player1 + " vs. " + player2 + " - draw");
      }
	}
	...
	public static char rpslsMove() {
		// Write your code here 1pt
    int move = (int)(Math.random() * 100) % 5;
    if(move == 0)
      return 'r';
    else if(move == 1)
      return 'p';
	...
	public static int rpslsGame(char player1Move,char player2Move) {
		// Write your code here 1pt
    //Write the battle
    System.out.println(char2StrMove(player1Move) + " vs. " + char2StrMove(player2Move));
    //in the case player 1 wins:
    if(player1Move == 'k' && (player2Move == 's' || player2Move == 'r'))
      return 1;
    else if(player1Move == 's' && (player2Move == 'p' || player2Move == 'l'))
      return 1;
    else if(player1Move == 'p' && (player2Move == 'r' || player2Move == 'k'))
      return 1;
    else if(player1Move == 'r' && (player2Move == 'l' || player2Move == 's'))
      return 1;
    else if(player1Move == 'l' && (player2Move == 'k' || player2Move == 'p'))
      return 1;
    //in the case player 2 wins:
    else if(player2Move == 'k' && (player1Move == 's' || player1Move == 'r'))
      return -1;
    else if(player2Move == 's' && (player1Move == 'p' || player1Move == 'l'))
      return -1;
    else if(player2Move == 'p' && (player1Move == 'r' || player1Move == 'k'))
      return -1;
    else if(player2Move == 'r' && (player1Move == 'l' || player1Move == 's'))
      return -1;
    else if(player2Move == 'l' && (player1Move == 'k' || player1Move == 'p'))
      return -1;
